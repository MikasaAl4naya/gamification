...
router.register(r'avatars', PreloadedAvatarUploadViewSet, basename='preloaded-avatars')
router.register(r'achievements', AchievementViewSet, basename='achievement')
router.register(r'templates', TemplateViewSet, basename='template')
router.register(r'complexity-thresholds', ComplexityThresholdsViewSet, basename='complexity-thresholds')
...
urlpatterns = [
    ...
    path('get_complaints/', get_employee_complaints, name='get_employee_complaints'),
